    ...
    <!-- /.Tabel 3 -->
      ...
      <?php if ($_SESSION['status'] == 1) {?>
        <form enctype="multipart/form-data" action="?controller=SAPS&action=UbahStatus" method="post" class="form-style-7" style="padding-top:100px">
          ...
          <input class='btn btn-primary tombol_tl' type="submit" name="lengkap" value="Tidak Lengkap">
          <input class='btn btn-primary tombol_l' type="submit" name="lengkap" value="Lengkap">
          <a href="" class='btn btn-primary tombol' style="float:left">Download</a>
        </form>
      <?php } ?>
